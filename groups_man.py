...
class Groups_man:
    ...
    def update(self):
        ...
        self.solid_objects_group.add(self.block_group , self.enemy_group, self.crate_group, self.gun_crate_group, self.boss1_group, self.door_lock_group, self.table_group)
